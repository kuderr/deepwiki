...
func (sdg *SimpleDocusaurus3Generator) Generate(structure *generator.WikiStructure, pages map[string]*generator.WikiPage, options OutputOptions) (*OutputResult, error) {
	startTime := time.Now()
...
func (sdg *SimpleDocusaurus3Generator) buildNavigationStructure(pages map[string]*generator.WikiPage) map[string][]NavigationItem {
...
func (sdg *SimpleDocusaurus3Generator) generateIntro(structure *generator.WikiStructure, pages map[string]*generator.WikiPage, filePath string, options OutputOptions, navStructure map[string][]NavigationItem) error {
...
func (sdg *SimpleDocusaurus3Generator) generatePage(page *generator.WikiPage, filePath string, structure *generator.WikiStructure, options OutputOptions, navStructure map[string][]NavigationItem) error {
	var content strings.Builder
