...
var rootCmd = &cobra.Command{
	...
	Long: `DeepWiki CLI is a Go-based tool that analyzes your local codebase and generates
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.deepwiki-cli.yaml)")
...
var versionCmd = &cobra.Command{
	...
	Long:  `Print the version, git commit, and build date of deepwiki-cli.`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Printf("deepwiki-cli version %s\n", Version)
